...
yarn	autoclean	[-I|--init,-F|--force	[-I|--init,-F|--force
yarn	bin	<executable
...
yarn	publish	[--access public,--tag #tag,--new-version #version	[--access public,--tag #tag,--new-version #version	[--access public,--tag #tag,--new-version #version	<folderOrTarball
yarn	publish	[--access restricted,--tag #tag,--new-version #version	[--access restricted,--tag #tag,--new-version #version	[--access restricted,--tag #tag,--new-version #version	<folderOrTarball
...
yarn	upgrade	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L
yarn	upgrade	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--caret	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--caret	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--caret	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--caret	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--caret
yarn	upgrade	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--tilde	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--tilde	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--tilde	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--tilde	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--tilde
yarn	upgrade	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--exact	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--exact	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--exact	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--exact	[-S|--scope #@scope,--ignore-engines,--pattern #pattern,--latest|-L,--exact
