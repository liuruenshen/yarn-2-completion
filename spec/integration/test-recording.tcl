...
set yarn_exec_a_completion [string cat \
  "acpid       addgroup    adjtimex    arch        arping      ash         autopasswd  \r\n" \
  "add-shell   adduser     apk         arp         asciinema   autoexpect  awk         \r\n" \
  $default_bash_prompt]
...
set timeout 30
send_and_expect "apk add asciinema\r"
set timeout 5
send_and_expect "asciinema rec -t \"yarn-2-completion demo\"\r"
...
send_and_expect "de\t" "" "" "ploy" 1
send_and_expect "$negative_acknowledge" "" "" $match_final_erase_in_line 1

send_and_expect "exit\r" "" "" "enter.+" 1
send_and_expect "\r"
